...
Training for BotCL:
python main_retri.py --num_classes 50 --num_cpt 20 --lr 0.0005 --epoch 80 --lr_drop 60 --pre_train False --dataset CUB200 --dataset_dir "your dir" --weak_supervision_bias 1 --quantity_bias 0.5 --distinctiveness_bias 1 --consistence_bias 1
```
...
python vis_retri.py --num_classes 20 --num_cpt 50 --index 300 --top_sample 20 --top_sample 50 --dataset CUB200
```
